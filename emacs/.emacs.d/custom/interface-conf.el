...
;; (add-to-list 'default-frame-alist '(font . "ohsnap-12:bold" ))
;; (add-to-list 'default-frame-alist '(font . "ohsnap-12:bold" ))
;; (set-face-attribute 'default t :font "ohsnap-12:bold" )
(add-to-list 'default-frame-alist '(font . "Inconsolata-11:bold" ))
(add-to-list 'default-frame-alist '(font . "Inconsolata-11:bold" ))
(set-face-attribute 'default t :font "Inconsolata-11:bold" )
;;(add-to-list 'default-frame-alist '(font . "tewi-9" ))
;;(add-to-list 'default-frame-alist '(font . "tewi-9" ))
;;(set-face-attribute 'default t :font "tewi-9" )
;;(set-frame-font "tewi-medium 14" nil t)
